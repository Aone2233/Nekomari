...
// `buttonVariants` lives in its own module so that button.tsx only exports the
// Button component: react-refresh can then hot-replace it (a module that exports
// both a component and a plain value cannot be refreshed in place).
