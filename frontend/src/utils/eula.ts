...
重要提示
  本文档旨在明确 Nekomari（“本软件”）的合法使用边界、用户权利义务与风险提示。请在下载、安装或使用本软件前，务必完整阅读并理解本声明的全部内容。一经下载、安装或使用，即视为您已理解并同意受本声明约束。
...
2. 定义
  ...
  - “本软件/Nekomari”：指开源发布的 Nekomari Monitor 及相关组件、示例、脚本与文档。
...
重要提示
  本文件旨在明確 Nekomari（“本軟體”）的合法使用邊界、使用者權利義務與風險提示。請在下載、安裝或使用本軟體前，務必完整閱讀並理解本聲明的全部內容。一經下載、安裝或使用，即視為您已理解並同意受本聲明約束。
...
2. 定義
  ...
  - “本軟體/Nekomari”：指開源釋出的 Nekomari Monitor 及相關元件、示例、指令碼與文件。
...
2. Definitions
  ...
  - "Software/Nekomari": Nekomari Monitor, released as open source, and its related components, examples, scripts, and documentation.
...
重要な注意
  本書は、Nekomari（「本ソフトウェア」）の合法的な利用範囲、ユーザーの権利義務、およびリスクに関する注意事項を明確にすることを目的としています。本ソフトウェアをダウンロード、インストール、または使用する前に、本書の全内容を必ずお読みいただきご理解ください。ダウンロード、インストール、または使用した時点で、本書の内容を理解し同意したものとみなされます。
...
2. 定義
  ...
  - 「本ソフトウェア/Nekomari」：オープンソースとして公開されている Nekomari Monitor および関連コンポーネント、サンプル、スクリプト、ドキュメントを指します。
...
Penting
  Dokumen ini bertujuan untuk menjelaskan batas penggunaan Nekomari ("Perangkat Lunak") secara sah, hak dan kewajiban pengguna, serta peringatan risiko. Sebelum mengunduh, menginstal, atau menggunakan Perangkat Lunak, harap baca dan pahami seluruh isi pemberitahuan ini. Dengan mengunduh, menginstal, atau menggunakan Perangkat Lunak, Anda dianggap telah memahami dan menyetujui untuk terikat oleh pemberitahuan ini.
...
2. Definisi
  ...
  - "Perangkat Lunak/Nekomari": Nekomari Monitor yang dirilis sebagai sumber terbuka beserta komponen, contoh, skrip, dan dokumentasi terkait.
